...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    ...
    function fetchEvents(info, successCallback, failureCallback) {
        ...
        $.ajax({
            url: `/api/user-calendar-events/${user_id}`, // Your API endpoint
            type: 'GET',
    ...
    let calendar = new Calendar(calendarEl, {
      ...
      eventClassNames: function ({ event: calendarEvent }) {
        ...
        const eventStatus = calendarEvent.extendedProps.status; // Adjust the property name as needed
      ...
      eventClick: function (info) {
        ...
        window.location.href = `/user/detail-request/request/${eventId}`;
      },
      datesSet: function () {
        modifyToggler();
      },
