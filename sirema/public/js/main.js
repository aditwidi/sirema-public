...
(function () {
  ...
  $('.dropdown-notifications-read, .dropdown-notifications-archive').click(function() {
...
function updateUnreadNotificationsCount(decrement = true) {
  var countElement = document.getElementById('unreadNotificationsCount');
...
function markAllNotificationsAsRead() {
  $.ajax({
      url: '/update-all-notifications-status', // Update this URL to your endpoint
      type: 'POST',
      data: {
          _token: $('meta[name="csrf-token"]').attr('content'),
          status: 'read'
      ...
      success: function(response) {
          ...
          updateUnreadNotificationsCount(false); // Update the count to 0
      },
      error: function(error) {
