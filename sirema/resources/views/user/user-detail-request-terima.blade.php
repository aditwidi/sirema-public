...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
                                ...
                                <div class="dropdown-menu dropdown-menu-end py-0">
                                    <div class="dropdown-menu-header border-bottom">
                                        <div class="dropdown-header d-flex align-items-center py-3">
                                            ...
                                            <a href="{{ url("javascript:void(0)") }}" class="dropdown-shortcuts-add text-body"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end py-0">
                                    <li class="dropdown-menu-header border-bottom">
                                        <div class="dropdown-header d-flex align-items-center py-3">
                                            ...
                                            <a href="{{ url("javascript:void(0)") }}" class="dropdown-notifications-all text-body"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h6 class="mb-1">{{ $notifikasi->message }}</h6>
                                                        <p class="mb-0">Request dengan judul "{{ $notifikasi->pengajuan->judul_request }}"
                                                            @if($notifikasi->pengajuan->status == 'pending')
                                                                telah dibuat
                                                            @elseif ($notifikasi->pengajuan->status == 'disetujui')
                                                                telah diterima
                                        ...
                                        <div id="account-details-vertical2" class="content">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <button class="btn btn-primary" onclick="redirectToRequestList()">
        ...
        <!-- Core JS -->
        <script>
            function redirectToRequestList() {
                window.location.href = '{{ route("user.list-request") }}';
            }
        </script>
