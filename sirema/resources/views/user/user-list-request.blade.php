...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('json/') }}" data-template="vertical-menu-template-no-customizer">
...
<head>
    ...
    <title>Sirema - List Request</title>
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Requests /</span> List Request
                        </h4>
                        <!-- Request List Table -->
                        <div class="card">
    ...
    <script type="text/javascript">
        // Define global variable for add request URL
        var addRequestUrl = "{{ route('user.ajukan-request') }}";
    </script>
    ...
    <!-- Page JS -->
    <script src="{{ asset('js/app-request-user.js') }}"></script>
