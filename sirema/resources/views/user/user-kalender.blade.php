                        ...
                        <div class="app-brand demo">
                            <a href="{{ route('user') }}" class="app-brand-link">
                                <span class="app-brand-logo">
                                    <img src="{{ asset('img/branding/logo-sm.png') }}" alt="logo" width="50"
                                        height="50">
                                </span>
                                            ...
                                            <div class="dropdown-shortcuts-list scrollable-container">
                                                <div class="row row-bordered overflow-visible g-0">
                                                    <div class="dropdown-shortcuts-item col">
                                                        ...
                                                        <a href="{{ route('user.list-request') }}"
                                                            class="stretched-link">Requests</a>
                                                    ...
                                                    <div class="dropdown-shortcuts-item col">
                                                        ...
                                                        <a href="{{ route('user.ajukan-request') }}"
                                                            class="stretched-link">Requests</a>
                                                ...
                                                <div class="row row-bordered overflow-visible g-0">
                                                    <div class="dropdown-shortcuts-item col">
                                                        ...
                                                        <a href="{{ url()->current() }}"
                                                            class="stretched-link">Kalender</a>
                                            ...
                                            <li>
                                                <div class="dropdown-item" style="pointer-events:none;">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <span
                                                                class="fw-semibold d-block">{{ $user->name }}</span>
                                                            <small
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="app-calendar-events-filter ms-3">
                                                    <div class="form-check form-check-success mb-2">
                                                        <input class="form-check-input input-filter" type="checkbox"
                                                            id="select-disetujui" data-value="disetujui" checked />
                                                        <label class="form-check-label"
                                                            for="select-disetujui">Kegiatan Media Kampus</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="app-calendar-events-filter ms-3">
                                                    <div class="form-check form-check-warning mb-2">
                                                        <input class="form-check-input input-filter" type="checkbox"
                                                            id="select-pending" data-value="pending" checked />
                                                        <label class="form-check-label" for="select-pending">Pengajuan
                                                            Anda (Pending)</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="app-calendar-events-filter ms-3">
                                                    <div class="form-check form-check-danger mb-2">
                                                        <input class="form-check-input input-filter" type="checkbox"
                                                            id="select-ditolak" data-value="ditolak" checked />
                                                        <label class="form-check-label" for="select-ditolak">Pengajuan
                                                            Anda (Ditolak)</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col app-calendar-content">
                                            ...
                                            <div class="offcanvas offcanvas-end event-sidebar" tabindex="-1"
                                                ...
                                                <div class="offcanvas-header my-1">
                                                    <h5 class="offcanvas-title" id="addEventSidebarLabel">Add Event
                                                    </h5>
                                                    ...
                                                    <form class="event-form pt-0" id="eventForm"
                                                        ...
                                                        <div class="mb-3 select2-primary">
                                                            ...
                                                            <select class="select2 select-event-guests form-select"
                                                                ...
                                                                <option data-avatar="9.png" value="Sandy Vega">Sandy
                                                                    Vega
                                                                </option>
                                                                <option data-avatar="11.png" value="Cheryl May">Cheryl
                                                                    May
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="eventLocation">Location</label>
                                                            <input type="text" class="form-control"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            , made with ❤️ by <a href="{{ url('#') }}" target="_blank"
                                                class="fw-semibold">Media Kampus</a>
                                        </div>
                                    </div>
                                </div>
                            </footer>
