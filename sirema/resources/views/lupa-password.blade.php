...
<head>
    ...
    <title>Sirema | Lupa Password</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <div class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold">SIREMA</span>
                            </div>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Lupa Password Anda? 🔒</h4>
                        <p class="mb-4">Masukkan Email Anda dan Tunggu Beberapa Saat untuk Mendapatkan Link Reset Password</p>
