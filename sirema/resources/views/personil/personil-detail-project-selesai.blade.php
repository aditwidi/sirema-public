...
<head>
  ...
  <title>Sirema - Detail Project</title>
      ...
      <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
          ...
          <div class="layout-page">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Projects/</span> Detail Project
            </h4>
            <!-- Default -->
            <div class="row">
                <div class="col-12">
                    <h5>Lihat Detail Project "{{ $request->judul_request }}"</h5>
                </div>
                    ...
                    <div class="bs-stepper vertical wizard-vertical-icons-example mt-2">
                        <div class="bs-stepper-header">
                            ...
                            <div class="step" data-target="#account-details-vertical2">
                                <button type="button" class="step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title">Detail Personil</span>
                                        <span class="bs-stepper-subtitle">Berisi Data Personil Terkait</span>
                                    </span>
                                </button>
                            </div>
                        </div>
                        <div class="bs-stepper-content">
                            ...
                            <div id="account-details-vertical2" class="content">
                                <div class="content-header mb-3">
                                    <h6 class="mb-0">Personil Terkait</h6>
                                </div>
                                <div class="row g-3">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="col-md-12 mb-4">
                                                ...
                                                @if($assignedPersonel->isNotEmpty())
                                                    <ul class="list-group">
                                                        @foreach ($assignedPersonel as $person)
                                                            <li class="list-group-item">{{ $person->name }}</li>
                                                        @endforeach
                                                    </ul>
                                                @else
                                                    <p>Belum ada Personel yang konfirmasi.</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <button class="btn btn-primary" onclick="redirectToPersonilRequestList()">
                                            <span class="align-middle me-sm-1">Confirm</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
          ...
          <!-- / Layout wrapper -->
          <script>
            function redirectToPersonilRequestList() {
