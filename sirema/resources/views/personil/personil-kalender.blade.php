...
<body>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="border-bottom p-4 my-sm-0 mb-3">
                            <div class="d-grid">
                            <a href="{{ route('project.list') }}" class="btn btn-primary btn-toggle-sidebar">
                                <span class="align-middle">List Project Anda</span>
                            </a>
                            </div>
                        </div>
                        <div class="p-3">
                            ...
                            <div class="form-check form-check-warning mb-2">
                                <input class="form-check-input input-filter" type="checkbox" id="select-pending" data-value="projectAnda" checked />
                                <label class="form-check-label" for="select-pending">Project Anda</label>
                            </div>
                            </div>
                        </div>
                        </div>
    ...
    <script src="{{ asset("js/app-personil-calendar.js") }}"></script>
