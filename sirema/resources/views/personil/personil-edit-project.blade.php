...
<head>
  ...
  <title>Sirema - Konfirmasi Project</title>
          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Projects/</span> Konfirmasi Project
                </h4>
                <!-- Default -->
                <div class="row">
                  <div class="col-12">
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <div class="d-flex ml-auto">
                                    <form action="{{ route('personil.selesaikan-project', $request->id) }}" method="POST" id="personilSelesaikanProject">
                                        @csrf
                                        <button type="submit" class="btn btn-success">Selesaikan Project</button>
                                    </form>
                                </div>
                             </div>
                          </div>
