                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <div class="d-flex ml-auto">
                                   <a href="{{ route('personil.edit.project.tolak', ['id' => $request->id]) }}" class="btn btn-danger me-2 ms-3">Tolak Project</a>
                                   <form action="{{ route('personil.terima-project', $request->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-success">Terima Project</button>
                                    </form>
                                </div>
                             </div>
                          </div>
