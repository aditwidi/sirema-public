...
<body>
              ...
              <div class="col-xl-3 col-md-3 col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title mb-1 pt-2">Total Project</h5>
                    <small class="text-muted">Last week</small>
                    <p class="mb-2 mt-1 fw-bolder">{{ $totalProjects }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-md-3 col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title mb-1 pt-2">Project selesai</h5>
                    <small class="text-muted">Last week</small>
                    <p class="mb-2 mt-1 fw-bolder">{{ $totalCompletedProjects }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-md-3 col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title mb-1 pt-2">Project dalam proses</h5>
                    <small class="text-muted">Last week</small>
                    <p class="mb-2 mt-1 fw-bolder">{{ $totalOngoingProjects }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-md-3 col-6 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title mb-1 pt-2">Project lewat deadline</h5>
                    <small class="text-muted">Last week</small>
                    <p class="mb-2 mt-1 fw-bolder">{{ $totalProjectsDeadlinePassed }}</p>
                  </div>
                </div>
              </div>
  ...
  <!-- Page JS -->
  <script src="{{ asset("js/app-request-list-personil.js") }}"></script>
