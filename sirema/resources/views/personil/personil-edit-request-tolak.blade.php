...
<head>
  ...
  <title>Sirema - Konfirmasi Request</title>
        ...
        <div class="layout-container">
          ...
          <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
              <a href="{{ route('personil') }}" class="app-brand-link">
          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Requests/</span> Konfirmasi Request
                </h4>
                <!-- Default -->
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="col-12 mb-4">
                        <div class="bs-stepper vertical wizard-vertical-icons-example mt-2" id="myStepper">
                            ...
                            <div class="bs-stepper-content">
                                ...
                                <div id="personal-info-vertical" class="content">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @endphp
                                            <p class="me-lg-2">
                                                <span class="badge {{ $statusBadgeMap[$request->status] ?? 'bg-secondary' }}"
                                                    text-capitalized>{{ ucfirst($request->status) }}</span>
                                            </p>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            @endphp
                                            <p class="me-lg-2">
                                                <span class="badge {{ $progressBadgeMap[$request->project->progress] ?? 'bg-secondary' }}"
                                                    text-capitalized>{{ $request->project->progress }}</span>
                                            </p>
                                        </div>
                                ...
                                <div id="account-details-vertical2" class="content">
                                    <form method="POST" action="{{ route('personil.tolak.project', ['projectId' => $projectId]) }}" id="personilTolakProject">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <div class="content-header mb-2">
                                                <h6 class="mb-0">Personil Pengganti</h6>
                                            </div>
                                            <div class="col-sm-12 mb-4">
                                                <input id="TagifyUserList" name="personil" class="form-control" data-required-personil="{{ $request->required_personil }}"/>
                                            </div>
                                                <div class="col-12 d-flex justify-content-end">
                                                    <button class="btn btn-success" type="submit">
                                                    <span
                                                        class="align-middle me-sm-1">Submit</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
