    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto;">
        ...
        <tr>
            <td style="background-color: #ffffff; padding: 20px;">
                <p style="font-size: 16px; color: #333333;">Halo <strong>{{$details['nama']}}</strong>!</p>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 16px; color: #333333;">
                    <tr>
                        ...
                        <td style="padding: 5px 0;">{{$details['nama']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 5px 0;">Website</td>
                        <td style="padding: 5px 10px;">:</td>
                        <td style="padding: 5px 0;">{{$details['website']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 5px 0;">Tanggal Register</td>
                        <td style="padding: 5px 10px;">:</td>
                        <td style="padding: 5px 0;">{{$details['datetime']}}</td>
                    </tr>
                </table>
