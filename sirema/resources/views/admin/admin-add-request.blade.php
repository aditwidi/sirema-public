...
<head>
  ...
  <title>Sirema - Ajukan Request</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Requests/</span> Ajukan Request
            </h4>
            <!-- Default -->
            <div class="row">
              <div class="col-12">
              ...
              <div class="col-12 mb-4">
                <div class="bs-stepper wizard-numbered mt-2">
                  ...
                  <div class="bs-stepper-content">
                    <form method="POST" action="{{ route('admin.request.store') }}" id="adminRequestForm">
                      @csrf
                      ...
                      <div id="account-details" class="content">
                        <div class="row g-3">
                          <div class="col-sm-6">
                            ...
                            <input type="text" id="namaPengaju" name="nama_pengaju" class="form-control" placeholder="Masukan Nama Pengaju" value="{{ old('nama_pengaju') }}" />
                          </div>
                          <div class="col-sm-6">
                          ...
                          <div class="col-sm-6 form-password-toggle">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="nomorHandphone" name="nomor_telepon_pengaju" class="form-control nomorHandphone" placeholder="Masukan Nomor Telepon Anda" value="{{ old('nomor_telepon_pengaju') }}" />
                            </div>
                          </div>
                      ...
                      <div id="personal-info" class="content">
                        <div class="row g-3">
                          <div class="col-sm-6">
                            ...
                            <input type="text" id="judulRequest" name="judul_request" class="form-control" placeholder="Masukan Judul Request" value="{{ old('judul_request') }}" />
                          </div>
                          <div class="col-sm-6">
                            <label for="bentukRequest" class="form-label">Bentuk Request</label>
                            <select id="bentukRequest" name="bentuk_request_id" class="selectpicker w-auto" data-style="btn-default">
                              <option value="" disabled selected>Select Bentuk Request</option>
                              @foreach ($bentukRequests as $request)
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="deadline" name="deadline" placeholder="dd-mm-yyyy" disabled />
                            </div>
                            {{-- <label for="deadline" class="form-label">Deadline</label>
                          ...
                          <div class="col-sm-6">
                            ...
                            <input class="form-control" type="number" value="1" id="jumlahOrang" name="required_personil" />
                          </div>
    ...
    <!-- Page JS -->
        ...
        <script src="{{ asset('js/app-user-input-deadline.js') }}"></script>
