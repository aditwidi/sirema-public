                                    ...
                                    <div class="step" data-target="#account-details">
                                       <button type="button" class="step-trigger">
                                          ...
                                          <span class="bs-stepper-label">
                                             ...
                                             <span class="bs-stepper-subtitle">Berisi Informasi Umum Pengaju</span>
                                          </span>
                                       </button>
                                    </div>
                                    <div class="line">
                                       ...
                                       <div id="account-details" class="content">
                                          <div class="row g-3">
                                             <div class="col-sm-6">
                                                ...
                                                <input type="text" id="namaPengaju" name="nama_pengaju" class="form-control" value="{{ $request->nama_pengaju }}" disabled />
                                             </div>
                                             <div class="col-sm-6">
                                                <label for="asalPengaju" class="form-label">Asal Pengaju</label>
                                                <select id="asalPengaju" name="asal_pengaju" class="selectpicker w-100" data-style="btn-default" disabled>
                                             ...
                                             <div class="col-sm-6 form-password-toggle">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <input type="text" id="nomorHandphone" name="nomor_telepon_pengaju" class="form-control nomorHandphone" value="{{ substr($request->nomor_telepon_pengaju, 3) }}" disabled />
                                                </div>
                                             </div>
                                       ...
                                       <div id="personal-info" class="content">
                                          <div class="row g-3">
                                             <div class="col-sm-6">
                                                ...
                                                <input type="text" id="judulRequest" name="judul_request" class="form-control" value="{{ $request->judul_request }}" disabled />
                                             </div>
                                             <div class="col-sm-6">
                                                <label for="bentukRequest" class="form-label">Bentuk
                                                   Request</label>
                                                <select id="bentukRequest" name="bentuk_request_id" class="selectpicker w-auto" data-style="btn-default" disabled>
                                             ...
                                             <div class="col-sm-6">
                                                ...
                                                <input type="date" class="form-control" id="deadline" name="deadline" value="{{ $request->deadline->format('Y-m-d') }}" disabled />
                                             </div>
                                             <div class="col-sm-6">
                                                <label for="jumlahOrang" class="form-label">Jumlah Orang yang Dibutuhkan</label>
                                                <input class="form-control" type="number" id="jumlahOrang" name="required_personil" value="{{ $request->required_personil }}" disabled />
                                             </div>
                                             <div class="col-12 d-flex justify-content-between">
                                                <button type="button" class="btn btn-label-primary btn-prev">
                                                   <i class="ti ti-arrow-left me-sm-3"></i>
                                                   <span class="align-middle d-sm-inline-block d-none">Previous</span>
                                                </button>
                                                <div class="d-flex ml-auto">
                                                   <a href="{{ route('admin.edit.request.tolak', ['id' => $request->id]) }}" class="btn btn-danger me-2 ms-3">Tolak Request</a>
                                                   <a href="{{ route('admin.edit.request.terima', ['id' => $request->id]) }}" class="btn btn-success">Terima Request</a>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
