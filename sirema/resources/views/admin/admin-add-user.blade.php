...
<head>
  ...
  <title>Sirema - Tambah User</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users/</span> Tambah User
            </h4>

            <div class="col-md mb-4 mb-md-0">
              <div class="card">
                <h5 class="card-header">Form Penambahan User</h5>
                <div class="card-body">
                  <form method="POST" action="{{ route('admin.store-user') }}">
                    @csrf
                    <div class="mb-3">
                      <label class="form-label" for="basic-default-name">Nama</label>
                      <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="Nama Anda" required />
                    </div>
                    <div class="mb-3">
                      <label class="form-label" for="basic-default-email">Email</label>
                      <input type="email" name="email" id="basic-default-email" class="form-control" placeholder="youremail@mail.com" required />
                    </div>
                    <div class="mb-3 form-password-toggle">
                      <label class="form-label" for="basic-default-password">Password</label>
                      <div class="input-group input-group-merge">
                        <input type="password" name="password" id="basic-default-password" class="form-control" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="basic-default-password3" required />
                    ...
                    <div class="mb-3" id="divisi-select" style="display: none;">
                      ...
                      <select class="form-select" name="divisi" id="divisi-input" required>
                        ...
                        <option value="Reportase dan Kepenulisan">Reportase dan Kepenulisan</option>
                      </select>
                    </div>
                    <div class="row">
