...
<head>
   ...
   <title>Sirema - Dashboard Admin</title>
...
<body>
                     ...
                     <div class="col-xl-3 col-md-3 col-6 mb-4">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <p class="mb-2 mt-1 fw-bolder">{{ $totalRequests }}</p>
                           </div>
                        </div>
                     </div>
                     <!-- Total Sales -->
                     <div class="col-xl-3 col-md-3 col-6 mb-4">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <small class="text-muted">Last week</small>
                              <p class="mb-2 mt-1 fw-bolder">{{ $totalApproved }}</p>
                           </div>
                        </div>
                     </div>
                     <!-- Total Profit -->
                     <div class="col-xl-3 col-md-3 col-6 mb-4">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <small class="text-muted">Last week</small>
                              <p class="mb-2 mt-1 fw-bolder">{{ $totalPending }}</p>
                           </div>
                        </div>
                     </div>
                     <!-- Total Sales -->
                     <div class="col-xl-3 col-md-3 col-6 mb-4">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <small class="text-muted">Last week</small>
                              <p class="mb-2 mt-1 fw-bolder">{{ $totalRejected }}</p>
                           </div>
                        </div>
                     </div>
                     <!-- Projects table -->
   ...
   <!-- Page JS -->
   <script src="{{ asset("js/app-request-list-admin.js") }}"></script>
   <script src="{{ asset("js/charts-apex.js") }}"></script>
</body>
