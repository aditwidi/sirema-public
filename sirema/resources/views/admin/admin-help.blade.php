    ...
    <div class="layout-wrapper layout-content-navbar">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4">Bantuan</h4>
            ...
            <!-- Cards -->
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col align-self-center">
                                    <h5 class="card-title mb-0">Buku pedoman 📕</h5> <!-- Ganti link drive -->
                                </div>
                                <div class="col-auto d-flex align-items-center">
                                    <a class="btn btn-primary" href="https://bit.ly/BukuPedomanSirema" target="_blank" style="width: 100px;">Unduh</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col align-self-center">
                                    <h5 class="card-title mb-0">Kontak pengembang 📞</h5> <!-- Ganti link wa -->
                                </div>
                                <div class="col-auto d-flex align-items-center">
                                  <a class="btn btn-primary" href="https://wa.me/6288210083303" target="_blank" style="width: 100px;">Hubungi</a>
                                </div>
                            </div>
                        </div>
                    </div>
